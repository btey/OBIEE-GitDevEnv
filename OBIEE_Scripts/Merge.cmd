...
%OBIEE_CLIENT_HOME%\domains\bi\bitools\bin\admintool.cmd /command Scripts\AdminToolMerge.txt && xcopy /Y C:\Temp-Merge\current(1).rpd %REPO_ORIG% < Scripts\xcopy.txt && del C:\Temp-Merge\*.rpd
